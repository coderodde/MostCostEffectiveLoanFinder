...
/**
 * This test class implements the test for 
 * {@link net.coderodde.finance.loan.support.BinaryHeapPreprocessingMostCostEffectiveLoanFinder}.
 * 
 * @author Rodion "rodde" Efremov
 * @version 1.6 (Mar 14, 2018)
 */
public final class BinaryHeapPreprocessingMostCostEffectiveLoanFinderTest {
    ...
    public void test1() {
        ...
        MostCostEffectiveLoanFinder<String> finder = 
                new BinaryHeapPreprocessingMostCostEffectiveLoanFinder<>(graph);
